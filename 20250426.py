...
def main():
    ...
    """
    import argparse
    parser = argparse.ArgumentParser(description='3D人體姿態估計系統')
    parser.add_argument('--calibrate', action='store_true', help='執行相機標定')
    parser.add_argument('--process', action='store_true', help='處理視頻數據')
    ...
    if args.calibrate:
    ...
    elif args.process or not (args.calibrate or args.process):
        # 視頻處理模式 (當沒有指定參數時默認執行)
        print("執行視頻處理...")
        ...
        video_paths = {
            ...
            'r3': r"D:\20250116\recordings\part03\port_2-01162025125617-0000.avi",
            'r4': r"D:\20250116\recordings\part03\port_1-01162025125622-0000.avi"
        }
