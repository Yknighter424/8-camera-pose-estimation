...
def main():
    ...
    # 視頻路徑設置
    video_paths = {
        'l1': r"E:\8camera_0228\685\685-02282025150351-0000.avi",
        'l2': r"E:\8camera_0228\684\684-02282025150353-0000.avi",
        'l3': r"E:\8camera_0228\688\688-02282025150359-0000.avi",
        'c':  r"E:\8camera_0228\1034\1034-02282025150358-0000.avi",
        'r1': r"E:\8camera_0228\686\686-02282025150352-0000.avi",
        'r2': r"E:\8camera_0228\725\725-02282025150355-0000.avi",
        'r3': r"E:\8camera_0228\724\724-02282025150356-0000.avi",
        'r4': r"E:\8camera_0228\826\826-02282025150354-0000.avi"
    }
    ...
    # 優化點雲
    optimized_points = optimize_points_gom(points_3d, reference_lengths)
...
def optimize_points_gom(points_sequence):
    ...
    """
    # 計算第一幀的參考長度
    reference_lengths = calculate_reference_lengths(points_sequence[0])
